...
- Backend `/api/experiments/runs` and frontend experiment-record panel added for persisted strategy run summaries with visible parameters, expandable result rows, filtering, sorting, CSV export, saved-parameter reuse, and delete/clear controls.
