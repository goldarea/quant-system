...
- Backend `/api/experiments/runs` and frontend experiment-record panel added for persisted strategy run summaries with filtering, sorting, CSV export, and delete/clear controls.
