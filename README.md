...
performance metrics, server-side filter/sort controls, CSV export, saved-parameter reuse, and local delete/clear actions. The dashboard can also run MA crossover
